...
DiveLinker.prototype = (function () {
    ...
    return {
        ...
        "setProject": function (eiid) {
            // let url = "http://120.114.170.38/dive/" + eiid + "/player.html?eid="+eiid;
             let url = "https://dive.nutn.edu.tw/Experiment/kaleTestExperiment5.jsp?eid=" + eiid + "&record=false" ;
            //  let url = "https://dive.nutn.edu.tw/Experiment/kaleTestExperiment5.jsp?eid=" + eiid + "&record=false"  + "&r=" + Date.now();
            // let url = "https://dive.nutn.edu.tw/Experiment/kaleTestExperiment5.jsp?eid=" + eiid + "&record=false" + "&blockE=" + this.watermark + "&r=" + Date.now();
